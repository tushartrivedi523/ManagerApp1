...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-5">
    	<h3 class="text-center mb-5"><u>Upload Employee Detail</u></h3>
	    <form action="addEmployee" method="post">
	    
	      <div class="mb-3">
		    	<label for="empcode" class="form-label">Employee Code: </label>
		    	<input required type="text" name="employeeCode" class="form-control" id="empcode">
		  </div>
		  <div class="mb-3">
		  ...
		  <div class="mb-3">
		    ...
		    <input required type="text" name="dateOfBirth" class="form-control" id="empdob" placeholder="12-02-1996">
		  </div>
